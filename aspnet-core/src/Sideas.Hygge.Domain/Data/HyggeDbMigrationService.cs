...
{
    public class HyggeDbMigrationService : ITransientDependency
    {
        public ILogger<HyggeDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IHyggeDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public HyggeDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IHyggeDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<HyggeDbMigrationService>.Instance;
        }
